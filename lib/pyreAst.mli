(** This module provides tagless-final interfaces for the syntax of Python.
    ...
    {{:https://docs.python.org/3.12/library/ast.html} [ast]} module is an explicit design goal for
...
module TaglessFinal : sig
  ...
  (** This module provides a type that represents Python expression contexts.
      ...
      As of Python 3.12, there are 6 kinds of expressions with an explicit context field:
